...
var root_90 = _$_.template(`<h1 class="title">title</h1><p class="desc">description</p><!><!>`, 1, 5);
...
var root_114 = _$_.template(`<button class="toggle">Toggle</button><!><!>`, 1, 4);
...
var root_119 = _$_.template(`<button class="toggle-c1">Toggle C1</button><button class="toggle-c2">Toggle C2</button><button class="toggle-c3">Toggle C3</button><button class="toggle-c4">Toggle C4</button><div class="top">top</div><!><!><!>`, 1, 12);
